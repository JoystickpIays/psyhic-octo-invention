...
local DYWebhook = loadstring(game:HttpGet("https://raw.githubusercontent.com/YarhmReborn/Petsgo/refs/heads/main/Hook.lua"))()
...
if success then
    ...
    message = "```Error   : " .. errorMsg .. "\nExploit : " .. Executor .. "```\n\n**Please report this error to Unknown as it may be a critical error that could lead to vulnerabilities.**"
end
